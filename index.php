...
<div class="grid">
    ...
    <section>
        ...
        <?php if (!$news): ?>
            <article class="card">
                ...
                <p>
                    Lege im Adminpanel deinen ersten Beitrag an.
                </p>
            </article>
        <?php endif; ?>
    ...
    <aside>
        ...
        <div class="card">
            ...
            <p>
                Registriere dich, lies News, verfolge Events und baue deine
                Fansite Stück für Stück weiter aus.
            </p>

            <?php if (!current_user()): ?>
                <a class="btn" href="/register.php">Account erstellen</a>
            <?php endif; ?>
        </div>
...
<section class="feature-grid">
    ...
    <article class="card feature-card">
        <span class="badge">Gameplay</span>
        <h3>Events & Aktionen</h3>
        <p>
            Nutze Seiten oder News für Events, Gewinnspiele, Updates und
    ...
    <article class="card feature-card">
        ...
        <h3>Team & Support</h3>
        <p>
            Baue eine Teamseite mit Rängen, Aufgaben und Ansprechpartnern.
        </p>
    </article>
    ...
    <article class="card feature-card">
        ...
        <h3>Widgets</h3>
        <p>
            Füge Discord, Serverstatus oder Shoutbox als Widget hinzu.
        </p>
    </article>

    <article class="card feature-card">
        <span class="badge">Admin</span>
        <h3>Einfach verwalten</h3>
        <p>
            News, Seiten und Nutzer bleiben direkt im Adminpanel bearbeitbar.
        </p>
    </article>
